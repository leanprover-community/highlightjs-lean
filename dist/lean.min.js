hljs.registerLanguage("lean",(()=>{"use strict";return e=>{var a={
...
section:"section namespace end",strong:"sorry admit"
},s=e.COMMENT("--","$"),t=e.COMMENT("/-[^-]","-/"),n={className:"theorem",
beginKeywords:"def theorem lemma class instance structure",end:":=",
excludeEnd:!0,contains:[{className:"keyword",begin:/extends/
},e.inherit(e.TITLE_MODE,{
begin:/[A-Za-z_][\\w\u207F-\u209C\u1D62-\u1D6A\u2079\']*/}),{className:"params",
begin:/[([{]/,end:/[)\]}]/,endsParent:!1,keywords:a},{className:"symbol",
begin:/:/,endsParent:!0}],keywords:a};return{name:"lean",keywords:a,
contains:[e.QUOTE_STRING_MODE,e.NUMBER_MODE,s,t,{className:"doctag",
begin:"/-[-!]",end:"-/"},n,{className:"meta",begin:"@\\[",end:"\\]"},{
